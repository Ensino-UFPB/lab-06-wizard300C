...
const mensagensDeErro = {
  ...
  instagram: {
    ...
    customError: "O @ precisa estar no começo do seu nome de usuário.",
  },
  nome: {
...
function validarTelefone(input) {
  const telefoneRecebido = input.value;
  let mensagem = "";
  if (
    !checarTelefoneDigitosRepetidos(telefoneRecebido) ||
    !checarTelefoneValido(telefoneRecebido)
  ) {
    mensagem = "O Telefone digitado não é válido.";
  }
}

function checarTelefoneDigitosRepetidos(telefone) {
  ...
  digitosRepetidos.array.forEach((numero) => {
    if (numero == telefone) {
...
function checarTelefoneValido(telefone) {
